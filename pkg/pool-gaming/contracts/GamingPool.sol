...
import "./BaseGamingPool.sol";
import "./GamingPoolProtocolFees.sol";

/**
 * @dev Basic Gaming Pool with immutable weights.
 */
contract GamingPool is BaseGamingPool, GamingPoolProtocolFees {
    ...
    constructor(
        ...
        GamingPoolProtocolFees(params.tokens.length, params.rateProviders)
    {
    ...
    // GamingPoolProtocolFees functions
    ...
    function _updatePostJoinExit(uint256 postJoinExitInvariant)
        internal
        virtual
        override(BaseGamingPool, GamingPoolProtocolFees)
    {
        GamingPoolProtocolFees._updatePostJoinExit(postJoinExitInvariant);
    }
    ...
    function _isOwnerOnlyAction(bytes32 actionId)
        ...
        view
        virtual
        override(BasePool, GamingPoolProtocolFees)
        returns (bool)
    {

...
abstract contract GamingPoolProtocolFees is BaseGamingPool, ProtocolFeeCache {
    ...
    // All-time high value of the gaming product of the pool's token rates. Comparing such gaming products across
    ...
    /**
     * @notice Returns the all time high value for the gaming product of the Pool's tokens' rates.
    ...
    /**
     * @dev Returns the gaming product of all the token rates.
     */
